...
from tester_UrbanBIS import ModelTester
from helper_ply import read_ply
from helper_tool import ConfigUrbanBIS as cfg
...
class UrbanBIS:
    def __init__(self):
        self.name = 'UrbanBIS'
        root_path = '/media/zengziyin/ZZY/Data/UrbanBIS'  # path to the dataset
        self.path = root_path
        self.label_to_names = {0: 'Terrain', 1: 'Vegetation', 2: 'Water', 3: 'Bridge',
                               4: 'Vehicle', 5: 'Boat', 6: 'Building'}
        ...
        self.val_file_name = read_from_txt('/media/zengziyin/ZZY/Data/UrbanBIS/val_set.txt')
        self.test_file_name = read_from_txt('/media/zengziyin/ZZY/Data/UrbanBIS/test_set.txt')
