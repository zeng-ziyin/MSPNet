...
class SensatUrban:
    def __init__(self):
        ...
        root_path = '/media/zengziyin/ZZY/Data/SensatUrban'  # path to the dataset
        self.path = root_path
        ...
        self.all_files = ['birmingham_block_1.ply', 'birmingham_block_2.ply',
                          'birmingham_block_5.ply', 'birmingham_block_6.ply',
                          'birmingham_block_9.ply']
        self.val_file_name = ['birmingham_block_9']
        ...
        self.use_val = False  # whether use validation set or not
