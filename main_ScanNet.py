...
class ScanNet:
    def __init__(self, test_area_idx):
        self.name = 'ScanNet'
        self.path = '/media/zengziyin/ZZY/Data/ScanNet/all_data'
        ...
        self.val_split = read_from_txt('/media/zengziyin/ZZY/Data/ScanNet/scannetv2_val.txt')
    ...
    def load_sub_sampled_clouds(self, sub_grid_size):
        ...
        for i, file_path in enumerate(self.all_files):
            ...
            # print(cloud_name.split('_')[0])
            # print(cloud_name.split('_')[0]+"_"+cloud_name.split('_')[1])
            # print(self.val_split)
            if cloud_name.split('_')[0]+"_"+cloud_name.split('_')[1] in self.val_split:
